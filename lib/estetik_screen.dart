...
import 'package:guzellik_merkezi/oneri_screen.dart'; // LatLng importu

class EstetikScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Estetik Hizmetleri")),
      body: Container(
